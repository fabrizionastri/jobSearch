...
import {
  ...
  faBriefcase,
  faGraduationCap
} from '@fortawesome/free-solid-svg-icons' // import the faSearch icon from the free-solid-svg-icons library
...
library.add(
  ...
  faBriefcase,
  faGraduationCap
) // add the faSearch icon to the library of FontAwesome icons
